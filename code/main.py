...
class Meteor(pygame.sprite.Sprite):
    ...
    def update(self, dt):
        ...
        self.image = pygame.transform.rotozoom(self.orignal_surface, self.rotation,1 )
...
def display_score():
    ...
    diplay_surface.blit(text_surf,text_rect)
    pygame.draw.rect(diplay_surface,(240,240,240),text_rect.inflate(20,10).move(0,-8), 5,10)
